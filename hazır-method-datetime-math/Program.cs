internal class Program
{
    private static void Main(string[] args)
    {
        ...
        Console.WriteLine(Math.Ceiling(22.3));//üst
        Console.WriteLine(Math.Round(22.3));//yakın
        Console.WriteLine(Math.Floor(22.3));//alt
        ...
        Console.WriteLine(Math.Log(9));//e tabanında 9 
